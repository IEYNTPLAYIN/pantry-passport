...
export function SubscriptionManager() {
  ...
  return (
    <main className="mx-auto min-h-screen max-w-6xl px-4 py-6 sm:px-6 sm:py-10 lg:px-10 lg:py-14">
      <Link
        href="/"
        className="inline-flex min-h-11 items-center gap-2 rounded-full px-2 text-sm font-semibold text-ink/65 transition hover:text-ink focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-meadow"
      >
      ...
      <section className="relative mt-4 overflow-hidden rounded-[2rem] border border-white/70 bg-white/85 shadow-soft backdrop-blur-md">
        ...
        <div className="grid lg:grid-cols-[1.15fr_0.85fr]">
          <div className="relative p-7 sm:p-10 lg:p-14">
            ...
            <p className="mt-8 text-sm font-semibold uppercase tracking-[0.22em] text-meadow">
            ...
            <div className="mt-8">
              {subscriptionStatus.isPending ? (
                ...
                <SubscribeButton
                  ...
                  label={checkoutPending ? t.loading : t.subscribe}
          ...
          <aside className="relative m-4 rounded-[1.6rem] bg-ink p-7 text-white sm:m-6 sm:p-9 lg:m-8 lg:ml-0">
            ...
            <h2 className="mt-3 text-2xl font-semibold">
              {subscription?.isActive ? t.statusActive : t.statusInactive}
            </h2>
              ...
              <div className="mt-8">
                {showCancelConfirmation ? (
                  <div className="rounded-2xl border border-white/15 bg-white/5 p-5">
                    ...
                    <div className="mt-5 flex flex-col gap-3">
                      <button
                        ...
                        className="min-h-11 rounded-full bg-peach px-4 text-sm font-semibold text-ink transition hover:bg-[#f5a06f] disabled:opacity-60"
                      >
                      ...
                      <button
                        ...
                        className="min-h-11 rounded-full border border-white/20 px-4 text-sm font-semibold transition hover:bg-white/10 disabled:opacity-60"
                      >
                        {t.keepSubscription}
                      </button>
                    </div>
                  ...
                  <button
                    ...
                    className="min-h-11 rounded-full border border-white/25 px-5 text-sm font-semibold text-white transition hover:border-peach/60 hover:bg-white/10"
                  >
            ...
            {actionError ? (
              <p className="mt-5 text-sm leading-6 text-[#ffd3c0]">
                {actionError}
              </p>
            ) : null}
          </aside>
